...
admin.initializeApp({
  credential: admin.credential.cert({
    ...
    project_id: "prizebondbot",  // Not sensitive
    private_key_id: process.env.FIREBASE_PRIVATE_KEY_ID,  // Sensitive
    private_key: process.env.FIREBASE_PRIVATE_KEY.replace(/\\n/g, '\n'),  // Sensitive
    client_email: process.env.FIREBASE_CLIENT_EMAIL,  // Sensitive
    client_id: "112933415710381597512",  // Not sensitive
    auth_uri: "https://accounts.google.com/o/oauth2/auth",  // Not sensitive
    token_uri: "https://oauth2.googleapis.com/token",  // Not sensitive
    auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",  // Not sensitive
    client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40prizebondbot.iam.gserviceaccount.com"  // Not sensitive
  }),
  databaseURL: "https://prizebondbot-default-rtdb.asia-southeast1.firebasedatabase.app/"  // Not sensitive
});
